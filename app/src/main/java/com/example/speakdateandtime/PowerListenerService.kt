...
class PowerListenerService : Service(), TextToSpeech.OnInitListener {
    ...
    companion object {
        ...
        private const val VOLUME_DAY = 0.1      // 白天音量
        private const val VOLUME_NIGHT = 0.1    // 深夜音量
    }
    ...
    override fun onCreate() {
        ...
        // 取消播报的 PendingIntent
        val cancelIntent = Intent(this, PowerListenerService::class.java).apply {
        ...
        startForeground(
            ...
            NotificationCompat.Builder(this, CHANNEL_ID)  // 通知构建器
                ...
                .addAction(android.R.drawable.ic_menu_close_clear_cancel, "取消播报", cancelPendingIntent)  // 加取消按钮
                .build()                                        // 构建通知对象
        )
    ...
    private fun getBatteryInfo(): String {
        // ==================== 获取电量信息 ====================
        val batteryManager = getSystemService(BATTERY_SERVICE) as BatteryManager    // getSystemService获取系统级服务的引用；as 强制类型转换
        val batteryLevel = batteryManager.getIntProperty(BatteryManager.BATTERY_PROPERTY_CAPACITY)    // 电池电量百分比
